...
from twinvla.model.modeling.mobilevlmv2.model.vision_encoder import build_vision_tower
from twinvla.model.modeling.mobilevlmv2.model.vision_projector import build_vision_projector
from twinvla.model.modeling.mobilevlmv2.constants import IGNORE_INDEX, IMAGE_TOKEN_INDEX, \
...
def load_pretrained_model(model_path, load_8bit=False, load_4bit=False, device_map="auto", device="cuda", dtype=torch.bfloat16):
    from twinvla.model.modeling.model.mobilellama import MobileLlamaForCausalLM

...
from twinvla.datasets.rlds.oxe.configs import OXE_DATASET_CONFIGS, ActionEncoding
from twinvla.datasets.rlds.oxe.transforms import OXE_STANDARDIZATION_TRANSFORMS
...
def make_oxe_dataset_kwargs(
    ...
    # Normalize all action dimensions *except* the gripper / If I need to normalize gripper, apply in collator
    ...
    elif dataset_kwargs["action_encoding"] is ActionEncoding.ABS_EEF_R6:
        dataset_kwargs["absolute_action_mask"] = [True] * 10
        dataset_kwargs["action_normalization_mask"] = [True] * 3 + [False] * 7
    ...
    elif dataset_kwargs['action_encoding'] is ActionEncoding.EEF_R6_BIMANUAL:
        dataset_kwargs["absolute_action_mask"] = [True] * 20
        dataset_kwargs["action_normalization_mask"] = [True] * 3 + [False] * 7 + [True] * 3 + [False] * 7
